				...
				<AnimatePresence>
					{urlError && (
						<motion.div
							...
							className="mb-6 w-full max-w-md rounded-xl border border-red-200 bg-red-50 p-4 text-red-900 shadow-sm dark:border-red-900/30 dark:bg-red-900/20 dark:text-red-200"
						>
