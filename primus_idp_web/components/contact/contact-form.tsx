	...
	return (
		<div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-4 py-10 md:px-6 md:py-20 lg:grid-cols-2">
			<div className="relative flex flex-col items-center overflow-hidden lg:items-start">
				<div className="flex items-start justify-start">
					<FeatureIconContainer className="flex items-center justify-center overflow-hidden">
						<IconMailFilled className="h-6 w-6 text-indigo-600 dark:text-indigo-400" />
					</FeatureIconContainer>
				</div>
				<h2 className="mt-9 bg-gradient-to-b from-slate-800 to-slate-900 bg-clip-text text-left text-xl font-bold text-transparent md:text-3xl lg:text-5xl dark:from-slate-200 dark:to-slate-300">
					Contact
				</h2>
				...
				<div className="mt-10 hidden flex-col items-center gap-4 md:flex-row lg:flex">
					<Link
						href="mailto:akki@primussoft.com"
			...
			<form
				...
				className="relative mx-auto flex w-full max-w-2xl flex-col items-start gap-4 overflow-hidden rounded-3xl bg-gradient-to-b from-slate-100 to-slate-200 p-4 sm:p-10 dark:from-slate-900 dark:to-slate-950"
			>
				<Grid size={20} />
				<div className="relative z-20 mb-4 w-full">
					<label
						className="mb-2 inline-block text-sm font-medium text-slate-600 dark:text-slate-300"
						htmlFor="name"
					>
						Full name
					</label>
					<input
						...
						{...register("name")}
						className={cn(
							"shadow-input h-10 w-full rounded-md border bg-white pl-4 text-sm text-slate-700 placeholder-slate-500 outline-none focus:ring-2 focus:ring-indigo-500 focus:outline-none active:outline-none dark:border-slate-700 dark:bg-slate-800 dark:text-white",
				...
				<div className="relative z-20 mb-4 w-full">
					...
					<textarea
						...
						{...register("message")}
						className={cn(
							"shadow-input w-full rounded-md border bg-white pt-4 pl-4 text-sm text-slate-700 placeholder-slate-500 outline-none focus:ring-2 focus:ring-indigo-500 focus:outline-none active:outline-none dark:border-slate-700 dark:bg-slate-800 dark:text-white",
				...
				<button
					...
					className="relative z-10 flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-[0px_1px_0px_0px_#FFFFFF20_inset] transition duration-200 hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm"
				>
	...
	return (
		...
		>
			<div className="h-full w-full">
				...
				<>
					<motion.div className="absolute right-1/2 bottom-1/2 h-20 w-px translate-y-[14px] bg-gradient-to-b from-transparent to-indigo-600 blur-[2px]" />
					<motion.div className="absolute right-1/2 bottom-1/2 h-20 w-px translate-y-[14px] bg-gradient-to-b from-transparent to-indigo-600" />
					<motion.div className="absolute right-1/2 bottom-1/2 z-40 h-[4px] w-[4px] translate-x-[1.5px] translate-y-[14px] rounded-full bg-violet-500 blur-[3px]" />
					<motion.div className="absolute right-1/2 bottom-1/2 z-40 h-[2px] w-[2px] translate-x-[0.5px] translate-y-[14px] rounded-full bg-indigo-400" />
				</>
			</div>
		</motion.div>
	);
...
export const FeatureIconContainer = ({
	...
	return (
		...
		>
			...
			<div className="absolute inset-x-0 bottom-0 mx-auto h-px w-[60%] bg-gradient-to-r from-transparent via-indigo-600 to-transparent"></div>
			<div className="absolute inset-x-0 bottom-0 mx-auto h-px w-[60%] bg-gradient-to-r from-transparent via-violet-500 to-transparent dark:h-[8px] dark:blur-sm"></div>
		</div>
	);
};
